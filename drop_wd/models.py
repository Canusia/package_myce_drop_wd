...
class DropWDRequest(models.Model):
    ...
    def send_received_notification(self):
        ...
        context = Context({
            ...
            'student_first_name': instance.registration.student.user.first_name,
            'student_last_name': instance.registration.student.user.last_name,
            'instructor_first_name': instance.registration.class_section.teacher.user.first_name if instance.registration.class_section.teacher else '-',
            'instructor_last_name': instance.registration.class_section.teacher.user.last_name if instance.registration.class_section.teacher else '-',
            'course_name': instance.registration.class_section.course,
            'term': instance.registration.class_section.term,
            'note': instance.note,
        })
